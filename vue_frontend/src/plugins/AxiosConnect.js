...
const ports = {
  users: { docker: '49165', local: '8081' },
  restaurants: { docker: '49164', local: '8080' },
  recipes: { docker: '49163', local: '8083' },
  permissions: { docker: '49162', local: '8082' },
  orders: { docker: '49161', local: '8084' },
  deliveries: { docker: '49160', local: '8085' }
}
...
=======
    async createRestaurant (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.restaurants[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/register_resto?data=${JSON.stringify(data)}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async getRestaurantList (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.restaurants[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_resto_list?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async updateRestaurant (user_id, restaurant_id, changes) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.restaurants[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update/${restaurant_id}?id=${user_id}&changes=${JSON.stringify(changes)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async deleteRestaurant (user_id, restaurant_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.restaurants[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete/${restaurant_id}?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async createRecipe (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/create_recipe?id=${user_id}&data=${JSON.stringify(data)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async getRecipes (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/list_recipes?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async getRecipesMultiple (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/list_recipes_multiple?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async updateRecipe (user_id, recipe_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update_recipe?id=${user_id}&recipe=${recipe_id}&data=${JSON.stringify(data)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async deleteRecipe (user_id, recipe_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete_recipe?id=${user_id}&recipe=${recipe_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async createMenu (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/create_menu?data=${JSON.stringify(data)}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getMenu (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/read_menu?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async updateMenu (user_id, menu_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update_menu?id=${user_id}&data=${JSON.stringify(data)}&menu=${menu_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async deleteMenu (user_id, menu_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.recipes[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete_menu?id=${user_id}&menu=${menu_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getPermissionByRole (role) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.permissions[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/list_permissions_by_role?role=${role}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getTypeList (callback) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.permissions[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_type_list`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async createOrder (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/create_order?data=${JSON.stringify(data)}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getOrder (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/list_order?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async updateOrder (user_id, order_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update_order?id=${user_id}&data=${JSON.stringify(data)}&order=${order_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async deleteOrder (user_id, order_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete_order?id=${user_id}&order=${order_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async validateOrder (user_id, order_id, restaurant_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/validate?order=${order_id}&restaurant=${restaurant_id}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async payOrder (user_id, order_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/pay?id=${user_id}&order=${order_id}&data=${JSON.stringify(data)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
...
=======
    async orderHistory (type, id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/order_history/${type}?id=${id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getStats (user_id, restaurant_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.orders[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_stats?id=${user_id}&restaurant=${restaurant_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async createDelivery (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/create_delivery?data=${JSON.stringify(data)}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getDelivery (constraint) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_deliveries?constraint=${JSON.stringify(constraint)}`)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async updateDelivery (user_id, delivery_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update_delivery?data=${JSON.stringify(data)}&id=${user_id}&delivery=${delivery_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async deleteDelivery (user_id, delivery_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete_delivery?delivery=${delivery_id}&id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getRequestedDeliery (user_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_requested_delivery?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async createDeliveryRequest (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.deliveries[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/create_delivery_request?id=${user_id}&data=${JSON.stringify(data)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async createUser (data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/register?data=${JSON.stringify(data)}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async updateUser (user_id, data) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/update?data=${JSON.stringify(data)}&id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async login (email, password) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/login?email=${email}&pass=${password}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getUser (user_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/getuser?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getUserList (user_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/getuserlist?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async deleteUser (user_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.delete(`${baseurl}/delete?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async changeUserElevation (user_id, new_level) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.put(`${baseurl}/change_user_elev?id=${user_id}&level=${new_level}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async regenToken (user_id) {
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.post(`${baseurl}/regen_token?id=${user_id}`, {}, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
    ...
    async getUserLevel (user_id) {
      ...
      baseurl = ApiConnect.#getNewbaseUrl(ports.users[currentEnv])
      try {
        const res = await axios.get(`${baseurl}/get_level?id=${user_id}`, this.header)
        return res.data
      } catch (e) {
        console.log(e)
      }
